...
INSERT INTO "new_Settings" ("id", "lastFmApiKey", "lastFmApiSecret", "lidarrApiKey", "lidarrDefaultProfileId", "lidarrRootFolderPath", "lidarrUrl", "mediaPathMap", "notificationWebhookUrl", "preDownloadMixes", "prowlarrApiKey", "prowlarrUrl", "qbittorrentPassword", "qbittorrentUrl", "qbittorrentUsername", "setupComplete", "slskdApiKey", "slskdDownloadPath", "slskdUrl", "trackTorrentCategory", "trackTorrentMaxSizeMb", "trackTorrentSavePath") SELECT "id", "lastFmApiKey", "lastFmApiSecret", "lidarrApiKey", "lidarrDefaultProfileId", "lidarrRootFolderPath", "lidarrUrl", "mediaPathMap", "notificationWebhookUrl", "preDownloadMixes", "prowlarrApiKey", "prowlarrUrl", "qbittorrentPassword", "qbittorrentUrl", "qbittorrentUsername", "setupComplete", "slskdApiKey", "slskdDownloadPath", "slskdUrl", "trackTorrentCategory", "trackTorrentMaxSizeMb", "trackTorrentSavePath" FROM "Settings";
DROP TABLE "Settings";
